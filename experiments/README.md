...
| Confidence-Gated UF–MWPM at `d=7`, `p=0.003` | V1 stopped at the mandatory 1k fresh-process replay gate. V2 repaired replay and passed its fresh 1k gate, but its disjoint 10k characterization stopped before any range commit because a 312/313-shot normalized metric tree exceeded the frozen 128 MiB ceiling. V3 raises only that ceiling to 512 MiB, adds exact and projected 313-shot capacity gates, and restarts with five fresh roots. V1/V2 artifacts remain immutable. | Non-claim-bearing single-cell paired accuracy, workload, confidence-routing, and software-latency characterization. | [`CONFIDENCE_GATED_UF_MWPM_D7_P003.md`](CONFIDENCE_GATED_UF_MWPM_D7_P003.md). |
