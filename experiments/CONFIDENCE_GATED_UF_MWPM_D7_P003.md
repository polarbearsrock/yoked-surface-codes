...
- **Status:** implementation complete; frozen scientific collection pending
- **Date:** 2026-08-30
...
- **Latency sampling:** controlled timing on the immutable 10,000-shot
  ...
  denominator
- **Implementation status:** decoder, paired collector, analyzer, replay gate,
  and latency harness are implemented; the frozen protocol and scientific
  result artifacts are intentionally created only after commit-A gates pass
...
The scientific collection follows the repository's two-commit pattern:

1. **Implementation commit A** contains all decoder, graph, collector,
...
2. Generate the complete frozen protocol from a clean worktree at A.
3. **Config-only commit B** changes exactly one file relative to A:
   `docs/PATCH_UF_MWPM_D7_P003_FROZEN_V1.json`.
4. Run the shakeout and characterization from a clean worktree at B.
5. The runner records A and B and verifies that `git diff --name-only A..B`
...
tools/benchmark_patch_uf_mwpm freeze \
    ...
    --out-protocol docs/PATCH_UF_MWPM_D7_P003_FROZEN_V1.json
```

Authenticate the generated protocol, confirm that the A-to-B diff contains
only `docs/PATCH_UF_MWPM_D7_P003_FROZEN_V1.json`, commit that one file as B,
and verify a clean worktree at B. Then run:

```bash
tools/benchmark_patch_uf_mwpm verify-protocol \
    --protocol docs/PATCH_UF_MWPM_D7_P003_FROZEN_V1.json

tools/benchmark_patch_uf_mwpm collect \
    --stage shakeout-1k \
    --protocol docs/PATCH_UF_MWPM_D7_P003_FROZEN_V1.json \
    --out out/cguf_mwpm_d7_p003_v1/shakeout_1k_collection \
    --processes 32

tools/benchmark_patch_uf_mwpm verify-collection \
    --stage shakeout-1k \
    --protocol docs/PATCH_UF_MWPM_D7_P003_FROZEN_V1.json \
    --input out/cguf_mwpm_d7_p003_v1/shakeout_1k_collection

tools/analyze_patch_uf_mwpm stage \
    --protocol docs/PATCH_UF_MWPM_D7_P003_FROZEN_V1.json \
    --collection out/cguf_mwpm_d7_p003_v1/shakeout_1k_collection \
    --stage engineering-shakeout \
    --out out/cguf_mwpm_d7_p003_v1/shakeout_1k_analysis

tools/benchmark_patch_uf_mwpm replay \
    --stage shakeout-1k \
    --protocol docs/PATCH_UF_MWPM_D7_P003_FROZEN_V1.json \
    --collection out/cguf_mwpm_d7_p003_v1/shakeout_1k_collection \
    --analysis out/cguf_mwpm_d7_p003_v1/shakeout_1k_analysis/analysis.json \
    --processes 32 \
    --out out/cguf_mwpm_d7_p003_v1/shakeout_1k_replay

tools/benchmark_patch_uf_mwpm collect \
    --stage characterization-10k \
    --protocol docs/PATCH_UF_MWPM_D7_P003_FROZEN_V1.json \
    --out out/cguf_mwpm_d7_p003_v1/characterization_10k_collection \
    --processes 32

tools/benchmark_patch_uf_mwpm verify-collection \
    --stage characterization-10k \
    --protocol docs/PATCH_UF_MWPM_D7_P003_FROZEN_V1.json \
    --input out/cguf_mwpm_d7_p003_v1/characterization_10k_collection

tools/analyze_patch_uf_mwpm stage \
    --protocol docs/PATCH_UF_MWPM_D7_P003_FROZEN_V1.json \
    --collection out/cguf_mwpm_d7_p003_v1/characterization_10k_collection \
    --stage characterization \
    --out out/cguf_mwpm_d7_p003_v1/characterization_10k_analysis

tools/benchmark_patch_uf_mwpm replay \
    --stage characterization-10k \
    --protocol docs/PATCH_UF_MWPM_D7_P003_FROZEN_V1.json \
    --collection out/cguf_mwpm_d7_p003_v1/characterization_10k_collection \
    --analysis out/cguf_mwpm_d7_p003_v1/characterization_10k_analysis/analysis.json \
    --processes 32 \
    --out out/cguf_mwpm_d7_p003_v1/characterization_10k_replay

tools/benchmark_patch_uf_mwpm latency \
    --protocol docs/PATCH_UF_MWPM_D7_P003_FROZEN_V1.json \
    --collection out/cguf_mwpm_d7_p003_v1/characterization_10k_collection \
    --out out/cguf_mwpm_d7_p003_v1/latency_collection

tools/benchmark_patch_uf_mwpm verify-latency \
    --protocol docs/PATCH_UF_MWPM_D7_P003_FROZEN_V1.json \
    --input out/cguf_mwpm_d7_p003_v1/latency_collection

tools/analyze_patch_uf_mwpm latency \
    --protocol docs/PATCH_UF_MWPM_D7_P003_FROZEN_V1.json \
    --input out/cguf_mwpm_d7_p003_v1/latency_collection \
    --out out/cguf_mwpm_d7_p003_v1/latency_analysis \
    --bootstrap-replicates 10000

tools/analyze_patch_uf_mwpm finalize \
    --protocol docs/PATCH_UF_MWPM_D7_P003_FROZEN_V1.json \
    --shakeout out/cguf_mwpm_d7_p003_v1/shakeout_1k_analysis \
    --characterization out/cguf_mwpm_d7_p003_v1/characterization_10k_analysis \
    --latency out/cguf_mwpm_d7_p003_v1/latency_analysis \
    --out out/cguf_mwpm_d7_p003_v1/finalization
```
