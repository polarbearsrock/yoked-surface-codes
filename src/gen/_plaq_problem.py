...
from gen._core._noise import occurs_in_classical_control_system
...
class PlaqProblem:
    ...
    def write_debug_files(self,
        ...
        with open(path, "w") as f:
            ...
            print(patch_svg_viewer(self.layouts), file=f)
        _print_wrote(path)
        ...
        with open(path, 'w') as f:
            ...
            print(stim_circuit_html_viewer(
                self.noisy_circuit,
                patch=self.layouts[0] if self.layouts else None,
                width=500,
                height=800,
