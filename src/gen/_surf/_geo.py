import collections
from typing import Iterable, List, Set, Dict, Optional, Sequence
...
def half_int_points_inside_int_polygon(corners: Sequence[complex], *, include_boundary: bool) -> Set[complex]:
